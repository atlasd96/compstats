...
\StringTok{  }\KeywordTok{geom_contour}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{alpha1, }\DataTypeTok{y=}\NormalTok{alpha2, }\DataTypeTok{z=}\NormalTok{likelihood), }\DataTypeTok{bins=}\NormalTok{n_bin) }\OperatorTok{+}\StringTok{ }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{steepest_ascent <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(f, fprime, alpha0, b, x, }\DataTypeTok{max_iter=}\DecValTok{10000}\NormalTok{, }\DataTypeTok{tol=}\NormalTok{.}\DecValTok{001}\NormalTok{)\{}
\NormalTok{  alpha_t <-}\StringTok{ }\NormalTok{alpha0}
...
\NormalTok{    h_t <-}\StringTok{ }\NormalTok{backtrack }\OperatorTok{*}\StringTok{ }\NormalTok{(}\KeywordTok{solve}\NormalTok{(M) }\OperatorTok{%*%}\StringTok{ }\NormalTok{fprime_x)}
    
    \CommentTok{# While the next point would be negative, backtrack (divide by 2)}
    \ControlFlowTok{while}\NormalTok{(}\KeywordTok{f}\NormalTok{(alpha0 }\OperatorTok{+}\StringTok{ }\NormalTok{h_t, b, x) }\OperatorTok{<}\StringTok{ }\KeywordTok{f}\NormalTok{(alpha0, b, x))\{}
\NormalTok{      backtrack <-}\StringTok{ }\NormalTok{backtrack }\OperatorTok{/}\StringTok{ }\DecValTok{2} 
\NormalTok{      h_t <-}\StringTok{ }\NormalTok{backtrack }\OperatorTok{*}\StringTok{ }\NormalTok{(}\KeywordTok{solve}\NormalTok{(M) }\OperatorTok{%*%}\StringTok{ }\NormalTok{fprime_x)}
\NormalTok{    \}}

    \CommentTok{# Iterate to the next point    }
\NormalTok{    alpha_t <-}\StringTok{ }\NormalTok{alpha0 }\OperatorTok{+}\StringTok{ }\NormalTok{h_t}
...
\KeywordTok{ggplot}\NormalTok{(results) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_contour}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{alpha1, }\DataTypeTok{y=}\NormalTok{alpha2, }\DataTypeTok{z=}\NormalTok{likelihood), }\DataTypeTok{bins=}\NormalTok{n_bin) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{solutions}\OperatorTok{$}\NormalTok{alpha_t[}\DecValTok{1}\NormalTok{], }\DataTypeTok{y=}\NormalTok{solutions}\OperatorTok{$}\NormalTok{alpha_t[}\DecValTok{2}\NormalTok{]), }\DataTypeTok{colour=}\StringTok{"purple"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_path}\NormalTok{(}\DataTypeTok{data=}\KeywordTok{data.frame}\NormalTok{(solutions}\OperatorTok{$}\NormalTok{path), }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{X1, }\DataTypeTok{y=}\NormalTok{X2)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\KeywordTok{TeX}\NormalTok{(}\StringTok{"$}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{alpha_1$"}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\KeywordTok{TeX}\NormalTok{(}\StringTok{"$}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{alpha_2$"}\NormalTok{)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Contour Plot of the Likelihood Function"}\NormalTok{) }\OperatorTok{+}
